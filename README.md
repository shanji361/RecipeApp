...
---
## Reference
- Consulted AI with navigation using sealed route classes, specifically in how to use createRoute() helper functions. This ensures consistency and prevents typos in route strings. It helped import libraries and clarified how to manage backstack behavior with popUpTo and launchSingleTop especially the placement of these. AI also assisted with the logic for generating a new recipe ID in addRecipe function in MainViewModel.kt. Asked AI about the difference of usage between NavHostController and NavController.
